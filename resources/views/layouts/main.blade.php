...
<head>
  ...
  {{-- Hapus jQuery kalau tidak dipakai --}}
  {{-- <script src="https://code.jquery.com/jquery-3.7.1.min.js"></script> --}}
</head>
<body class="theme-day">
  {{-- Form logout harus di dalam <body> --}}
  ...
  <div class="dashboard-wrapper">
    ...
    <div class="main-content">
      ...
      {{-- Jangan include layouts.script lagi, kita satukan JS di bawah --}}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  {{-- Tempat injeksi script per-halaman --}}
  @stack('scripts')
</body>
</html>
